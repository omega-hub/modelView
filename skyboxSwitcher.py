...
def setupSkyboxSwitcher(menu):
	...
	global skybox
	skybox = Skybox()
	skybox.loadCubeMap("skyboxes/grid4", "png")
	getSceneManager().setSkyBox(skybox)
	...
	misb1.setCommand('skyboxSwitcher.skybox.loadCubeMap("skyboxes/gradient1", "png")')
	misb1 = menuSkyboxes.addItem(MenuItemType.Button)
	misb1.setText("Gradient 2")
	misb1.setCommand('skyboxSwitcher.skybox.loadCubeMap("skyboxes/gradient2", "png")')
	misb1 = menuSkyboxes.addItem(MenuItemType.Button)
	misb1.setText("Grid 1")
	misb1.setCommand('skyboxSwitcher.skybox.loadCubeMap("skyboxes/grid3", "png")')
	misb1 = menuSkyboxes.addItem(MenuItemType.Button)
	misb1.setText("Grid 2")
	misb1.setCommand('skyboxSwitcher.skybox.loadCubeMap("skyboxes/grid4", "png")')
	misb1 = menuSkyboxes.addItem(MenuItemType.Button)
	misb1.setText("Stars")
	misb1.setCommand('skyboxSwitcher.skybox.loadCubeMap("skyboxes/stars1", "png")')
